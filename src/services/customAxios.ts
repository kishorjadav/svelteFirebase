...
// import { userCookie, userRefreshCookie } from '../cookies';
import { AUTH_COOKIE_NAME, AUTH_REFRESH_COOKIE_NAME } from '../cookies/cookieName';
import { removeCookie, setCookie } from '../cookies/useCookies';
    ...
    const refreshAccessToken = async (refreshToken: string) => {
        try {
            ...
            if (res) {
                ...
                setCookie(AUTH_REFRESH_COOKIE_NAME, res.data.refresh_token);
