        ...
        <ul class="mt-12">
          ...
          >
            <a href="/" class="flex items-center focus:outline-none">
              ...
              <span class="text-sm ml-2 {mini === true ? 'hidden' : 'block'} ">
                Dashboard
              </span>
            </a>
          </li>
          <li
            class="flex w-full justify-between cursor-pointer items-center mb-6"
          >
            <a href="/myprofile" class="flex items-center focus:outline-none">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <li
            class="flex w-full justify-between cursor-pointer items-center mb-6"
          >
            <a href="/customer" class="flex items-center focus:outline-none">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <li
            class="flex w-full justify-between cursor-pointer items-center mb-6"
          >
            <a href="/multifiles" class="flex items-center focus:outline-none">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        >
          <li class="cursor-pointer text-white pt-5 pb-3">
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="icon icon-tabler icon-tabler-bell mr-4"
                width="20"
                height="20"
                viewBox="0 0 24 24"
                stroke-width="1.5"
